...
BrainManager.prototype = {
    ...
    updateBrainColors: function () {
        var i, colors = [];
        for(i = 0; i < this.length; i++) {
            if (app.Config.currentStep == 2 && i < 1500) {
                ...
                colors[this.distance[i].index] = new THREE.Color(0xCC342C);
            } else if (app.Config.currentStep == 5 && i < 8000) {
                colors[this.distance[i].index] = new THREE.Color(0xCC342C);
            } else if (app.Config.currentStep == 6 && i < 12000) {
                colors[this.distance[i].index] = new THREE.Color(0xCC342C);
            } else if (app.Config.currentStep == 7 && i < 14500) {
                colors[this.distance[i].index] = new THREE.Color(0xCC342C);
            }
            else {
